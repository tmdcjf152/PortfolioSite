...
import { introState } from '../../atom';
import { Fade } from 'react-reveal';

const Introducation = () => {
	const [close, setClose] = useRecoilState(introState);
		...
		<IntroducationBlock>
			...
			<div className='box-inner-box center'>
				...
				<main className='info-inner-box center '>
						<iframe src='https://tmdcjf152.github.io/myInfoPage/#/resume' width='100%' height='100%'>
...
const IntroducationBlock = styled.div`
		.box-inner-box {
		position: fixed;
		top: 20px;
		left: 100px;
