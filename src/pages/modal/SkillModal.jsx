...
import { skillState } from '../../atom';
import { Fade } from 'react-reveal';

const SkillModal = () => {
	const [close, setClose] = useRecoilState(skillState);
	return (
		<SkillModalBlock>
									<Fade bottom big>
			<div className='box-inner-box center'>
				...
				<main className='info-inner-box center '>
						<iframe src='https://tmdcjf152.github.io/myInfoPage/#/skill' width='100%' height='100%'>
...
const SkillModalBlock = styled.div`
	.box-inner-box {
		position: fixed;
		margin: 0 auto;
		bottom: 70px;
